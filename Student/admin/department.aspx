<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="department.aspx.cs" Inherits="Student.admin.department" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="data-tables datatable-dark">
                            <center>
                                <asp:LinkButton ID="AddDepartmentButton" runat="server" CssClass="btn btn-sm btn-info" OnClick="AddDepartmentButton_Click">
                                    Add New Class
                                </asp:LinkButton>
                            </center>
                                    ...
                                    <asp:Repeater ID="DepartmentRepeater" runat="server" OnItemCommand="DepartmentRepeater_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%# Eval("DepartmentShortName") %></td>
