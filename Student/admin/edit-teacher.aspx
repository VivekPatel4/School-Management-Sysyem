<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="edit-teacher.aspx.cs" Inherits="Student.admin.edit_teacher" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="fuTeacherImage">Teacher Image</label>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <asp:TextBox ID="txtconfirmpassword" runat="server" CssClass="form-control" ReadOnly="true" />
                            ...
                            <asp:Button ID="btnUpdateTeacher" runat="server" Text="Update" CssClass="btn btn-primary"
                                OnClick="btnUpdateTeacher_Click" />
                        </div>
                    </div>
                </div>
            </div>
