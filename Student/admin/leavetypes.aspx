<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="leavetypes.aspx.cs" Inherits="Student.admin.leave" %>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12">
                <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left">
                        ...
                        <li><span>Leavetype Management</span></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="data-tables datatable-dark">
                            <center>
                                <asp:LinkButton ID="AddLeaveTypeButton" runat="server" CssClass="btn btn-sm btn-info" OnClick="AddLeaveTypeButton_Click">
                                  Add New Leave Type
                                </asp:LinkButton>
                            </center>
                            <table id="dataTable3" class="table table-hover table-striped text-center">
                                ...
                                <tbody>
                                    <asp:Repeater ID="LeavetypeRepeater" runat="server" OnItemCommand="LeavetypeRepeater_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
