<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="ApprovedHistory.aspx.cs" Inherits="Student.admin.ApprovedHistory" %>
        ...
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-6 col-sm-12">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Approve Section</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="dashboard.aspx">Home</a></li>
                        <li><span>Approve History</span></li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <asp:Repeater runat="server" ID="rptapprove">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%# Convert.ToString(Eval("Status")) == "1" ? "<span style='color: green'>Approved <i class='fa fa-thumbs-o-up'></i></span>" : "" %>
                                                    </td>
                                                    <td>
                                                        <asp:HyperLink
                                                            ID="lnkViewDetails"
