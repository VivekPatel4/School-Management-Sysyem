<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="edit-leavetype.aspx.cs" Inherits="Student.admin.edit_leavetype" %>
      ...
      <div class="row">
          <div class="col-12 mt-5">
              <div class="card">
                  ...
                  <div class="card-body">
                      <p class="text-muted font-14 mb-4">Please fill up the form in order to add Update LeaveType</p>
                      ...
                      <asp:Button ID="btnleavetype" runat="server" Text="Update" CssClass="btn btn-primary"
