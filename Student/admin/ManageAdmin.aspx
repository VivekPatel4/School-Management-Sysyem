<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="ManageAdmin.aspx.cs" Inherits="Student.admin.admin1" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="data-tables datatable-dark">
                            <center>
                                <asp:LinkButton ID="AddAdminbtn" runat="server" CssClass="btn btn-sm btn-info" OnClick="AddAdminbtn_Click">
                                    ...
                                    <asp:Repeater ID="AdminRepeater" runat="server" OnItemCommand="AdminRepeater_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%# Eval("UserName")  %></td>
                                                <td><%# Eval("email")  %></td>
                                                <td><%# String.Format("{0:yyyy-MM-dd}", Eval("updationDate")) %></td>
                                                <td>
