<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="teacher.aspx.cs" Inherits="Student.admin.teacher" %>
        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Teachers Section</h4>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="data-tables datatable-dark">
                            <center>
                                <asp:LinkButton ID="AddTeachertbtn" runat="server" CssClass="btn btn-sm btn-info" OnClick="AddTeachertbtn_Click">
                                  Add New Teacher
                                </asp:LinkButton>
                            </center>
                            ...
                            <table id="dataTable3" class="table table-hover table-striped text-center">
                                ...
                                <tbody>
                                    <asp:Repeater ID="TeacherRepeater" runat="server" OnItemCommand="TeacherRepeater_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:LinkButton ID="ViewDetailsButton" runat="server" CssClass="btn btn-sm btn-info"
                                                       ...
                                                       <i class="fa fa-eye" style="color:blue" title="View Teacher Details"></i>
                                                    </asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
