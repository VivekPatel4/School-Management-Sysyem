<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="edit-student.aspx.cs" Inherits="Student.admin.edit_student" %>
                ...
                <div class="card">
                    ...
                    <div class="content">
                        <div class="card-body">
                            ...
                            <asp:Button ID="btnUpdateStudent" runat="server" Text="Update" CssClass="btn btn-primary"
