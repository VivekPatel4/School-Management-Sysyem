<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="DeclinedHistory.aspx.cs" Inherits="Student.admin.DeclinedHistory" %>
        ...
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-6 col-sm-12">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Decline Section</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="dashboard.aspx">Home</a></li>
                        <li><span>Decline History</span></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="single-table">
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-bordered progress-table text-center">
                                    ...
                                    <tbody>
                                        <asp:Repeater runat="server" ID="rptdecline">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%# Convert.ToString(Eval("Status")) == "2" ? "<span style='color: red'>Not Approved <i class='fa fa-thumbs-o-down'></i></span>" : "" %>
                                                    </td>
                                                    <td>
                                                        <asp:HyperLink
                                                            ID="lnkViewDetails"
