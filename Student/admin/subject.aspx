<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="subject.aspx.cs" Inherits="Student.admin.subject" %>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12">
                <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left">
                        ...
                        <li><span>Subject Management</span></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="data-tables datatable-dark">
                            <center>
                                <asp:LinkButton ID="AddSubjectButton" runat="server" CssClass="btn btn-sm btn-info" OnClick="AddSubjectButton_Click">
                                Add New Subject
                                </asp:LinkButton>
                            </center>
                            <table id="dataTable3" class="table table-hover table-striped text-center">
                                ...
                                <tbody>
                                    <asp:Repeater ID="SubjectRepeater" runat="server" OnItemCommand="SubjectRepeater_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%# Container.ItemIndex + 1 %></td>
                                                <td><%# Eval("SubjectName") %></td>
                                                <td><%# Eval("SubjectShortName") %></td>
                                                <td><%# Eval("SubjectCode") %></td>
                                                <td><%# String.Format("{0:yyyy-MM-dd}", Eval("CreationDate")) %></td>
                                                <td>
