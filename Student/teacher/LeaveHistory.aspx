<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/teacher.Master" AutoEventWireup="true" CodeBehind="LeaveHistory.aspx.cs" Inherits="Student.teacher.LeaveHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Repeater ID="rptleavehistory" runat="server">
        <HeaderTemplate>
            <h1 class="pending-title">Leave History</h1>
            <table class="table">
                <thead>
                    <tr>
                        <td>S.N</td>
