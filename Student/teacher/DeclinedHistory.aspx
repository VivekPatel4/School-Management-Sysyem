<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/teacher.Master" AutoEventWireup="true" CodeBehind="DeclinedHistory.aspx.cs" Inherits="Student.teacher.DeclinedHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Repeater ID="rptdecline" runat="server">
        <HeaderTemplate>
            <h1 class="pending-title">Decline History</h1>
            <table class="table">
                <thead>
                    <tr>
                        <td>S.N</td>
