<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/teacher.Master" AutoEventWireup="true" CodeBehind="ApprovedHistory.aspx.cs" Inherits="Student.teacher.ApprovedHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Repeater ID="rptapprove" runat="server">
        <HeaderTemplate>
            <h1 class="pending-title">Approve History</h1>
            <table class="table">
                <thead>
                    <tr>
                        <td>S.N</td>
