...
face_recognizer = cv2.dnn.readNetFromTorch("C:\\vp\\information\\student\\Student\\Student\\Scripts\\nn4.small2.v1.t7")
...
if __name__ == "__main__":
    ...
    threshold = 0.9  # You can also pass this as an argument if needed
